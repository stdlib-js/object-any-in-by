...
```javascript
anyInBy = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/object-any-in-by@umd/browser.js' )
```
The previous example will load the latest bundled code from the umd branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/object-any-in-by/tags). For example,

```javascript
anyInBy = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/object-any-in-by@v0.1.1-umd/browser.js' )
```

To vendor stdlib functionality and avoid installing dependency trees for Node.js, you can use the UMD server build:

```javascript
var anyInBy = require( 'path/to/vendor/umd/object-any-in-by/index.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/object-any-in-by@umd/browser.js"></script>
```
...
[npm-image]: http://img.shields.io/npm/v/@stdlib/object-any-in-by.svg
[npm-url]: https://npmjs.org/package/@stdlib/object-any-in-by

[test-image]: https://github.com/stdlib-js/object-any-in-by/actions/workflows/test.yml/badge.svg?branch=v0.1.1
[test-url]: https://github.com/stdlib-js/object-any-in-by/actions/workflows/test.yml?query=branch:v0.1.1

[coverage-image]: https://img.shields.io/codecov/c/github/stdlib-js/object-any-in-by/main.svg
[coverage-url]: https://codecov.io/github/stdlib-js/object-any-in-by?branch=main

<!--

[dependencies-image]: https://img.shields.io/david/stdlib-js/object-any-in-by.svg
[dependencies-url]: https://david-dm.org/stdlib-js/object-any-in-by/main
...
[deno-url]: https://github.com/stdlib-js/object-any-in-by/tree/deno
[deno-readme]: https://github.com/stdlib-js/object-any-in-by/blob/deno/README.md
[umd-url]: https://github.com/stdlib-js/object-any-in-by/tree/umd
[umd-readme]: https://github.com/stdlib-js/object-any-in-by/blob/umd/README.md
[esm-url]: https://github.com/stdlib-js/object-any-in-by/tree/esm
[esm-readme]: https://github.com/stdlib-js/object-any-in-by/blob/esm/README.md
